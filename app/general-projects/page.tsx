...
const GeneralProjectsPage = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast.error("Code invalide ou vous appartenez déjà au projet" + error);
    }
  };
        ...
        {associatedProjects.length > 0 ? (
          ...
          <div>
            <EmptyState
              ...
              message="Vous n'êtes associé à aucun projet"
            />
          </div>
        )}
      </div>
...
export default GeneralProjectsPage;
